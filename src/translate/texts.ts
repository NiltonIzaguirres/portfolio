...
export const homeTranslate = {
  "en-US": {
    seo: {
      title: 'Home',
      description: 'A young full-stack developer and technology, hacking and design enthusiast'
    },
    welcomeSection: {
      hello: 'Hi, i am',
      resume: 'a young full-stack developer passionate about solving problems and creating solutions!',
    ...
    contactSection: {
      ...
      categories: {
        contact: {
          title: 'Contact',
          description: "If you need more information, for example my phone number, please don't hesitate to email me first.",
          country: 'Brazil'
        },
        mediaSocial: {
  ...
  "pt-BR": {
    seo: {
      title: 'Inicio',
      description: 'Um jovem desenvolvedor full-stack e entusiasta de tecnologia, hacking e design'
    },
    welcomeSection: {
      hello: 'Olá, sou',
      resume: 'um jovem desenvolvedor full-stack apaixonado por resolver problemas e criar soluções!',
    ...
    contactSection: {
      ...
      categories: {
        contact: {
          title: 'Contato',
          description: 'Se precisar de mais informações, por exemplo, meu número de telefone, não hesite em me enviar um e-mail primeiro.',
          country: 'Brasil'
        },
        mediaSocial: {
          title: 'Redes sociais'
